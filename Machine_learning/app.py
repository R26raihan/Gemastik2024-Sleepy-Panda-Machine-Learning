...
model = joblib.load(os.path.join(current_dir, 'xgb_model_Terbaik.pkl'))
gender_encoder = joblib.load(os.path.join(current_dir, 'Gender_label_encoder.pkl'))
occupation_encoder = joblib.load(os.path.join(current_dir, 'Occupation_label_encoder.pkl'))
bmi_encoder = joblib.load(os.path.join(current_dir, 'BMI Category_label_encoder.pkl'))
scaler = joblib.load(os.path.join(current_dir, 'minmax_scaler_split.pkl'))
